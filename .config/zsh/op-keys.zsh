...
_op_load ANTHROPIC_API_KEY "op://Personal/Anthropic API Key/credential"
# Add more as needed:
# _op_load OPENAI_API_KEY "op://Personal/OpenAI API Key/credential"
# _op_load GROQ_API_KEY   "op://Personal/Groq API Key/credential"
